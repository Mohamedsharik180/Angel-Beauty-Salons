...
CREATE TABLE `frm_login_user` (
  `txtbx_email` varchar(300) NOT NULL,
  `txtbx_pass` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `frm_login_user` (`txtbx_email`, `txtbx_pass`) VALUES
(1, 'frm_login_user', 'admin@gmail.com', '25f9e794323b453885f5181f1b624d0b');
